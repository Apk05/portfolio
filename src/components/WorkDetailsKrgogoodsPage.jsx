...
const mediaItems = [
  ...
  { id: '2', type: 'video', src: '/assets/Works/Krgogoods/desktop-rec-1.mov' },
  { id: '3', type: 'image', src: '/assets/Works/Krgogoods/krgosite-2.png' },
  { id: '4', type: 'video', src: '/assets/Works/Krgogoods/mobile-rec-1.mov', narrow: true },
  { id: '5', type: 'image', src: '/assets/Works/Krgogoods/krgosite-3.png' },
  { id: '6', type: 'video', src: '/assets/Works/Krgogoods/desktop-rec-2.mov' },
  { id: '7', type: 'video', src: '/assets/Works/Krgogoods/mobile-rec-2.mov', narrow: true },
  { id: '8', type: 'video', src: '/assets/Works/Krgogoods/mobile-rec-3.mov', narrow: true },
  { id: '9', type: 'video', src: '/assets/Works/Krgogoods/mobile-rec-4.mov', narrow: true },
]
...
export default function WorkDetailsKrgogoodsPage() {
        ...
        <div className="flex h-full items-center gap-20 overflow-x-auto overflow-y-hidden rounded-2xl bg-retro-charcoal950 p-3 pr-10 md:gap-32 md:p-5 md:pr-24">
          <section className="flex h-full w-[355px] min-w-[355px] shrink-0 flex-col justify-between rounded-2xl border-2 border-retro-charcoal700 p-4">
            ...
            <div className="mt-2 space-y-3 text-[13px] leading-[1.3] text-retro-charcoal400 md:text-[16px]">
              <p>
              Partnered with the Creative Director and development team to launch a streetwear e-commerce platform in two weeks, driving 50+ day-one orders. Also designed a custom mini-game interface used to reward customers at their Yangon launch event.
              </p>
              <ul className="list-disc space-y-1 pl-5">
                <li>Tools Used: Figma, Photoshop</li>
                <li>Contribution: UI/UX Design, Game Interface Design, Asset Customization</li>
              </ul>
              <p>
                <a
                  href="https://www.krgogoods.com/"
