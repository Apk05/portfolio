...
const mediaItems = [
  { id: '1', type: 'video', src: '/assets/Works/La Persona/1.mp4', narrow: true },
  { id: '2', type: 'image', src: '/assets/Works/La Persona/2.png' },
  { id: '3', type: 'image', src: '/assets/Works/La Persona/3.png' },
  { id: '4', type: 'video', src: '/assets/Works/La Persona/4.MP4', narrow: true },
  { id: '5', type: 'image', src: '/assets/Works/La Persona/5.png' },
  { id: '6', type: 'video', src: '/assets/Works/La Persona/6.MP4', narrow: true },
  { id: '7', type: 'image', src: '/assets/Works/La Persona/7.png' },
  { id: '8', type: 'video', src: '/assets/Works/La Persona/8.MP4', narrow: true },
]
...
export default function WorkDetailsLaPersonaPage() {
        ...
        <div className="flex h-full items-center gap-20 overflow-x-auto overflow-y-hidden rounded-2xl bg-retro-charcoal950 p-3 pr-10 md:gap-32 md:p-5 md:pr-24">
          <section className="flex h-full w-[355px] min-w-[355px] shrink-0 flex-col justify-between rounded-2xl border-2 border-retro-charcoal700 p-4">
            ...
            <div className="mt-2 space-y-3 text-[13px] leading-[1.3] text-retro-charcoal400 md:text-[16px]">
              <p>
              Designed and launched the V1 platform and brand identity from scratch, which directly helped secure 4 early paying customers.
              </p>
              <ul className="list-disc space-y-1 pl-5">
                <li>Tools Used: Figma, Illustrator, Spline 3D</li>
                <li>Contribution: Creative direction, Product strategy, Branding, User experience, Visual design</li>
              </ul>
              <p>
                <a
                  href="https://www.la-persona.com"
